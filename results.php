...
<form class="forrm" action="login.php" method="POST">
    ...
    <h1 style="font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: 18px;">Sorry! we have to verify you first. <br>Please log in</h1>              
